...
LANDING_FOLDER = Path(DATA_FOLDER / "landing")
INPUT_FOLDER = Path(DATA_FOLDER / "input")
QUARANTINE_FOLDER = Path(DATA_FOLDER / "quarantine")
UNKNOWN_FOLDER = Path(QUARANTINE_FOLDER / "unknown")
